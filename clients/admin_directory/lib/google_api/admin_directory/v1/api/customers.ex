...
defmodule GoogleApi.AdminDirectory.V1.Api.Customers do
  @moduledoc """
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Customer{}} on success
  {:error, info} on failure
  """
  @spec directory_customers_get(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Customer.t()} | {:error, Tesla.Env.t()}
  def directory_customers_get(connection, customer_key, opts \\ []) do
    ...
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Customer{})
  end
