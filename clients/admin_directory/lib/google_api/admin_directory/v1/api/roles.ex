...
defmodule GoogleApi.AdminDirectory.V1.Api.Roles do
  @moduledoc """
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Role{}} on success
  {:error, info} on failure
  """
  @spec directory_roles_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Role.t()} | {:error, Tesla.Env.t()}
  def directory_roles_get(connection, customer, role_id, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Role{})
  end
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Roles{}} on success
  {:error, info} on failure
  """
  @spec directory_roles_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Roles.t()} | {:error, Tesla.Env.t()}
  def directory_roles_list(connection, customer, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Roles{})
  end
