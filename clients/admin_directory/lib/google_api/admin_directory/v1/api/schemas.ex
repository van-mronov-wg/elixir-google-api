...
defmodule GoogleApi.AdminDirectory.V1.Api.Schemas do
  @moduledoc """
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Schema{}} on success
  {:error, info} on failure
  """
  @spec directory_schemas_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Schema.t()} | {:error, Tesla.Env.t()}
  def directory_schemas_get(connection, customer_id, schema_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Schema{})
  end
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Schemas{}} on success
  {:error, info} on failure
  """
  @spec directory_schemas_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Schemas.t()} | {:error, Tesla.Env.t()}
  def directory_schemas_list(connection, customer_id, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Schemas{})
  end
