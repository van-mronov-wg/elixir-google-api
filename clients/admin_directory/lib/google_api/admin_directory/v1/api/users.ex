...
defmodule GoogleApi.AdminDirectory.V1.Api.Users do
  @moduledoc """
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Channel{}} on success
  {:error, info} on failure
  """
  @spec directory_users_aliases_watch(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Channel.t()} | {:error, Tesla.Env.t()}
  def directory_users_aliases_watch(connection, user_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Channel{})
  end
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.User{}} on success
  {:error, info} on failure
  """
  @spec directory_users_get(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.User.t()} | {:error, Tesla.Env.t()}
  def directory_users_get(connection, user_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.User{})
  end
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Users{}} on success
  {:error, info} on failure
  """
  @spec directory_users_list(Tesla.Env.client(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Users.t()} | {:error, Tesla.Env.t()}
  def directory_users_list(connection, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Users{})
  end
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.UserPhoto{}} on success
  {:error, info} on failure
  """
  @spec directory_users_photos_get(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.UserPhoto.t()} | {:error, Tesla.Env.t()}
  def directory_users_photos_get(connection, user_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdminDirectory.V1.Model.UserPhoto{})
  end
