...
defmodule GoogleApi.AdminDirectory.V1.Api.Privileges do
  @moduledoc """
  ...
  {:ok, %GoogleApi.AdminDirectory.V1.Model.Privileges{}} on success
  {:error, info} on failure
  """
  @spec directory_privileges_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.AdminDirectory.V1.Model.Privileges.t()} | {:error, Tesla.Env.t()}
  def directory_privileges_list(connection, customer, opts \\ []) do
    ...
    |> decode(%GoogleApi.AdminDirectory.V1.Model.Privileges{})
  end
end
