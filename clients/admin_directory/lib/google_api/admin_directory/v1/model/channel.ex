...
defmodule GoogleApi.AdminDirectory.V1.Model.Channel do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdminDirectory.V1.Model.Channel do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdminDirectory.V1.Model.Channel do
