...
defmodule GoogleApi.AdminDirectory.V1.Model.Asps do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          etag: any(),
          items: list(GoogleApi.AdminDirectory.V1.Model.Asp.t()),
          kind: any()
        }
...
defimpl Poison.Decoder, for: GoogleApi.AdminDirectory.V1.Model.Asps do
  import GoogleApi.AdminDirectory.V1.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:items, :list, GoogleApi.AdminDirectory.V1.Model.Asp, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdminDirectory.V1.Model.Asps do
