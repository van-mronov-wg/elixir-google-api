...
defmodule GoogleApi.AdminDirectory.V1.Model.Role do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          roleId: any(),
          roleName: any(),
          rolePrivileges: list(GoogleApi.AdminDirectory.V1.Model.RoleRolePrivileges.t())
        }
...
defimpl Poison.Decoder, for: GoogleApi.AdminDirectory.V1.Model.Role do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :rolePrivileges,
      :list,
      GoogleApi.AdminDirectory.V1.Model.RoleRolePrivileges,
      options
    )
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdminDirectory.V1.Model.Role do
