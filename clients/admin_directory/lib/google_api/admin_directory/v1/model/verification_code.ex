...
defmodule GoogleApi.AdminDirectory.V1.Model.VerificationCode do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdminDirectory.V1.Model.VerificationCode do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdminDirectory.V1.Model.VerificationCode do
