...
defmodule GoogleApi.Admin.Directory_v1.Api.DomainAliases do
  ...
  @spec directory_domain_aliases_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.DomainAlias.t()} | {:error, Tesla.Env.t()}
  def directory_domain_aliases_get(connection, customer, domain_alias_name, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.DomainAlias{})
  end
  ...
  @spec directory_domain_aliases_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.DomainAliases.t()} | {:error, Tesla.Env.t()}
  def directory_domain_aliases_list(connection, customer, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.DomainAliases{})
  end
end
