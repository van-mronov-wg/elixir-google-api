...
defmodule GoogleApi.Admin.Directory_v1.Api.Groups do
  ...
  @spec directory_groups_get(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.Group.t()} | {:error, Tesla.Env.t()}
  def directory_groups_get(connection, group_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.Group{})
  end
  ...
  @spec directory_groups_list(Tesla.Env.client(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.Groups.t()} | {:error, Tesla.Env.t()}
  def directory_groups_list(connection, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.Groups{})
  end
