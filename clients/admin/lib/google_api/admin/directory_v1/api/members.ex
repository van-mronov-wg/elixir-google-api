...
defmodule GoogleApi.Admin.Directory_v1.Api.Members do
  ...
  @spec directory_members_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.Member.t()} | {:error, Tesla.Env.t()}
  def directory_members_get(connection, group_key, member_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.Member{})
  end
  ...
  @spec directory_members_has_member(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.MembersHasMember.t()} | {:error, Tesla.Env.t()}
  def directory_members_has_member(connection, group_key, member_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.MembersHasMember{})
  end
  ...
  @spec directory_members_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Admin.Directory_v1.Model.Members.t()} | {:error, Tesla.Env.t()}
  def directory_members_list(connection, group_key, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Admin.Directory_v1.Model.Members{})
  end
